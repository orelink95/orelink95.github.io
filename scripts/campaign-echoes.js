    ...
    sessions: [
        {
            ...
            npcsMet: [
                { id: "wardenfoll", sentiment: "positive" },
                { id: "erikthayne", sentiment: "dislike" },
            ],
            ...
            accomplished: [
                "Obtain authority from the Grand Warden to investigate crimes in Brightend.",
                "Met the families and neighbors of the victims of a string of murders.",
                "Uncovered a strange token and pinpointed the probable origin of a piece of fabric found in Maera's study."
            ],

            leadsPursued: [
                "Investigated the murder of Elira Thayne by talking to her husband and her employee at Finest Cloth",
                "Discovered that the courrier who had been killed actually carried the same metal the tokens are made of.",
            ],

            futureLeads: [
                "Investigate the thefts and disappearances plaguing the city"
            ],
        ...
        },
        {
            ...
            npcsMet: [
                ...
                { id: "wardenfoll", sentiment: "neutral" }
            ],
