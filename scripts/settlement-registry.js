...
<p><span class="float-left text-5xl font-headline text-error leading-none pr-2 pt-1">B</span>eneath the shadow of the industrial forges lies the Ash District. Crime is rampant, and the air is thick with soot.</p>
                ...
                ` },
                npcs: [
                    { id: 'silas-smug', name: 'Oldebear', role: 'Smuggler King', quote: 'The Gates check your papers, but the Docks only check your coin.', image: 'https://lh3.googleusercontent.com/aida-public/AB6AXuC-irB6beipaKqd88hSv3OI4FRCksQF_7s4eKHKxj4JWJA3qK1LuOgdygfW8oxtHuIVcI-SCe_hYCX69T8voZegbrpFRdsbCDLIldnTc8qzxui0ttJ4mN34Gce5bvAySGypePoPVdAWsJY_Ie7d9slV9VvrUeQx-SnuH5oZfCiHzz080vKa0Aw_Sji8u6MG-f6Y5zatQ5hAhVke82ZolwnQpmsO9ZEOCHMPw3VHcwp61mDBOlOPJPGOb55Eou8SZEv3FpM050AUHLM', homePinTitle: 'The Fighting Pits' }
                ],
                pins: [
                    {
                        y: 500, x: 500, icon: 'skull', title: 'The Fighting Pits', subtitle: 'Danger Zone', isDanger: true, isFeatured: false, isSafe: false, image: 'images/pois/brightend_fightpits.png', body: `
...
<p>The economic heart of the city.</p>
...
<p>The heavily militarized entrance to the capital.</p>
        ...
        districts: [
            {
                ...
                pins: [
                    {
                        y: 0, x: 0, icon: 'castle', title: 'Black Rose Inn', subtitle: 'Fresh Water, Warm Beds, Decent Wine... sometimes', isDanger: false, isFeatured: false, isSafe: false, image: '', body: `
